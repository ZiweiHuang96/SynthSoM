...
clone = Linear_net()
clone.load_state_dict(torch.load('mlp_TSTR_0309.params'))
clone.eval()
loss_func = nn.L1Loss()
...
for step, (building, label) in enumerate(Test_loader):
    ...
    label_path = 'E:\\Desktop\\Code_PT\\TSTR\\Network_TSTR\\label_test'
    output_path = 'E:\\Desktop\\Code_PT\\TSTR\\Network_TSTR\\output_test'
    ...
    errorpath = 'E:\\Desktop\\Code_PT\\TSTR\\Network_TSTR\\error'
