...
# DataLoader
train_dir = 'E:\\Desktop\\Code_PT\\TSTR\\Dataset_TSTR\\train'
test_dir = 'E:\\Desktop\\Code_PT\\TSTR\\Dataset_TSTR\\val'
...
plt.show()
with open("E:\\Desktop\\Code_PT\\TSTR\\Network_TSTR\\train_loss.txt", 'w') as train_los:
...
# 画loss曲线
train_loss_path = r"E:\Desktop\Code_PT\TSTR\Network_TSTR\train_loss.txt"
...
torch.save(net.state_dict(), 'mlp_TSTR_0309.params')
