...
errorpath_TSTR = 'E:\Desktop\DATA_SIMU\error\';
errorpath_TRTR = 'E:\Desktop\DATA\error\';
...
for i = 1:176
    ...
    if error>=0 && error<0.09
        TSTR1 = TSTR1 + 1;
    elseif error>=0.09 && error<0.18
        TSTR2 = TSTR2 + 1;
    elseif error>=0.18 && error<0.27
        TSTR3 = TSTR3 + 1;
    elseif error>=0.27 && error<0.36
        TSTR4 = TSTR4 + 1;
    elseif error>=0.36 && error<0.45
        TSTR5 = TSTR5 + 1;
...
set(gca,'xtick',[1:6]);
set(gca,'xticklabel',{'0~9%', '9%~18%','18%~27%','27%~36%','36%~45%'})
